...
class TrainModel(ap.Model):
    ...
    def update(self):
        ...
        routes_change = False # Used later to re-evaluate all routes
    ...
    def resolve_collisions(self):
        # This is the function that resolves the collision, which is
        # an expected time in steps and a positions where, if nothing
        # changes, two agents will share a same position or swap them.
        #
        # This function returns nothing but it should not really fail
        # to resolve any collision, unless the routes get messy.
...
if __name__=="__main__":
    ...
    # These are the parameters that define the processing of the image
    # and the rounds all trains will do in the simulation.
